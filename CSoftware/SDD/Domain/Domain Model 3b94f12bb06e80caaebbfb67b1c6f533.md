...
| State | String | Condición operativa (Activo, bloqueado, etc.) |
...
| status | InventoryStatus | Indica el estado actual del inventario. |
...
| Atributo | Tipo | Descripción |
| --- | --- | --- |
| ProductosSelecionados | CartStatus | Indica el estado actual del carrito. |
